...
model = dict(
    ...
    pts_voxel_layer=dict(
        max_num_points=10, voxel_size=voxel_size,  max_voxels=(90000, 12000),  point_cloud_range= [-84.0, -60.0, -3.0, 120.0, 60.0, 5.0]),
    pts_voxel_encoder=dict(type='HardSimpleVFE', num_features=4),
    pts_middle_encoder=dict(
        type='SparseEncoder',
        in_channels=4,
        #sparse_shape=[41, 1024, 1024],
        sparse_shape = [41, 1600, 2720],
        output_channels=128,
        order=('conv', 'norm', 'act'),
    ...
    pts_backbone=dict(
        type='SECOND_SelfCalib_ConvNeXtv2',
        in_channels=256,
